...
export class Init1787055357610 implements MigrationInterface {
  name = 'Init1787055357610';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX "public"."IDX_58c6b1221195ef87c2c4d62c84"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_1640c5627c5d3141a6eb5caa40"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_094c1eb759b086be91b6656883"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_e320d150d8f0119e9dda0167a9"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ca7fc35bdf60b33c9778f5e7c8"`,
    );
    await queryRunner.query(`DROP TABLE "render"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c7307813538ef39d59a9fdb485"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_044b4cbf9b8efa4d15e9d76110"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_df8aedd50509192d995535d68c"`,
    );
    await queryRunner.query(`DROP TABLE "pipeline"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_1328cc0f4c80cc998ab96c7383"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_33ffe08322582439ec109ad3c1"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_32565a216e335ed743410fa770"`,
    );
    await queryRunner.query(`DROP TABLE "log_piece"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_be67c65f46bf4a4cacaf31c60f"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_6a0830f03e537b239a53269b27"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_3105fa6c448e8846c395244f43"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b1bd840641b8acbaad89c3d8d1"`,
    );
